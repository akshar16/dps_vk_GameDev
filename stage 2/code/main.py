            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_ESCAPE:
                        ...
                        # Toggle memory flash; drains meter while active
                    ...
                    elif self.pattern_challenge_active and not self.pattern_challenge.showing:
                        # Pattern input
                ...
                # Mouse clicking removed - use shooting instead
